...
public interface TransientOptionTestOptions extends PersistenceOptions {
    @Option(transientOption = true, key = "transient.option")
    int getTransientOption();
    void setTransientOption(int value);
}
