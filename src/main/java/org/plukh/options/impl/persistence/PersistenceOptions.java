...
public interface PersistenceOptions extends Options {
    void saveToStream(OutputStream out, boolean nonDefaultOnly) throws OptionsException;
    void loadFromStream(InputStream in, boolean suppressConversionErrors) throws OptionsException;
}
